...
from ui.composer import Ui_Form
...
class ComposerWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Composer Assistant Builder")

        # Button wiring
        self.ui.composerAPI_SaveBtn.clicked.connect(self.on_save_composer)
        self.ui.updateBtn.clicked.connect(self.update_config)
        self.ui.cancelBtn.clicked.connect(self.close)

    def on_save_composer(self):
        ...
        try:
            assistant_id = create_and_save_assistant(api_key, "composer", name, prompt)
    ...
    def update_config(self):
        ...
        write_env_file(env_path, {
            ...
            "COMPOSER_ID": assistant_id,
            "COMPOSER_NAME": name or "Unnamed"
        })

        QMessageBox.information(self, "Updated", "✅ Composer assistant configuration updated.")
        if self.parent():
            self.parent().refresh_composer_assistant()
